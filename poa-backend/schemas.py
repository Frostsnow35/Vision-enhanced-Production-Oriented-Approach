...
class EvaluateSingleRequest(BaseModel):
    """POST /api/evaluate-single 请求体"""
    attempt_text: str
    task_context: Optional[Dict[str, Any]] = None


class EvaluateSingleResponse(BaseModel):
    """POST /api/evaluate-single 响应体"""
...
class EvaluateCompareResponse(BaseModel):
    """POST /api/evaluate-compare 响应体"""
    attempt1_scores: Dict[str, float]
    attempt2_scores: Dict[str, float]
