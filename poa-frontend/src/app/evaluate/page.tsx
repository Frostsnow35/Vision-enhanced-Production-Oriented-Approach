    ...
    return (
      <div className="mx-auto max-w-lg py-16 text-center">
        ...
        <div className="mt-6 flex gap-3 justify-center">
          <Button variant="outline" onClick={() => router.push("/attempt1")}>
            去初次产出
          </Button>
            ...
            <div key={dim} className="rounded-xl border border-border bg-card p-5 shadow-sm space-y-2">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div>
                  ...
                  <div className="mt-0.5 flex items-center gap-2">
                    <div className="h-2 flex-1 rounded-full bg-muted overflow-hidden">
                      <div className="h-full rounded-full bg-blue-500" style={{ width: `${((s.attempt1 || 0) / 5) * 100}%` }} />
                    </div>
                    <span className="w-7 text-right font-medium tabular-nums text-blue-600 dark:text-blue-400">
                ...
                <div>
                  ...
                  <div className="mt-0.5 flex items-center gap-2">
                    <div className="h-2 flex-1 rounded-full bg-muted overflow-hidden">
                      <div className="h-full rounded-full bg-orange-500" style={{ width: `${((s.attempt2 || 0) / 5) * 100}%` }} />
                    </div>
                    <span className="w-7 text-right font-medium tabular-nums text-orange-600 dark:text-orange-400">
